...
import NavButtonLeft from './home/NavButtonsLeft'
import { IconSquareRoundedArrowDown, IconSquareRoundedPlus } from '@tabler/icons-react'
        ...
        <Form {...form}>
          <form
            ...
            <div>
                ...
                <div key={step.id}>
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <LabelInputContainer>
                          <Label htmlFor={`steps.${index}.step_num`}>Step Number</Label>
                          <FormControl>
                            <InputAnimated
              ...
              <Button type="button" onClick={() => appendStep({ step_num: stepFields.length + 1, description: '' })}>
                Add Step
              </Button>
            </div>
