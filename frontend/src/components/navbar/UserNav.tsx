...
const UserNav = () => {
  return (
    <section
      id="nav-for-user"
      className="fixed w-full flex flex-row justify-between top-0 left-0 p-3 px-4 sm:px-7 lg:px-8 space-x-3 md:space-x-5 lg:space-x-7 backdrop-blur-lg backdrop-filter bg-opacity-30 z-50 border-b border-muted/30"
    >
